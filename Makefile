...
lta : list_toctas.o lib_sym.o utilities.o ps1.h Rotations/symmetries.h
	gcc list_toctas.o lib_sym.o utilities.o $(CFLAGS) `pkg-config --cflags --libs glib-2.0 ` -o lta
